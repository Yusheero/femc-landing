...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Oc(){return new ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sl(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Bc(){return new ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sl(),fragmentShader:`
...
}`;function AM(n,t,e){let i=new Ff;const s=new kt,r=new kt,o=new he,a=new q_({depthPacking:Xm}),l=new j_,c={},u=e.maxTextureSize,f={[ei]:ze,[ze]:ei,[Ln]:Ln},d=new ni({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new kt},radius:{value:4}},vertexShader:yM,fragmentShader:TM}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const x=new Di;x.setAttribute("position",new Mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Nn(x,d),_=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ff;let h=this.type;this.render=function(C,P,O){if(_.enabled===!1||_.autoUpdate===!1&&_.needsUpdate===!1||C.length===0)return;const T=n.getRenderTarget(),E=n.getActiveCubeFace(),D=n.getActiveMipmapLevel(),J=n.state;J.setBlending(Jn),J.buffers.color.setClear(1,1,1,1),J.buffers.depth.setTest(!0),J.setScissorTest(!1);const Y=h!==Cn&&this.type===Cn,$=h===Cn&&this.type!==Cn;for(let ot=0,K=C.length;ot<K;ot++){const et=C[ot],z=et.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",et,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const ft=z.getFrameExtents();if(s.multiply(ft),r.copy(z.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ft.x),s.x=r.x*ft.x,z.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ft.y),s.y=r.y*ft.y,z.mapSize.y=r.y)),z.map===null||Y===!0||$===!0){const Tt=this.type!==Cn?{minFilter:fn,magFilter:fn}:{};z.map!==null&&z.map.dispose(),z.map=new wi(s.x,s.y,Tt),z.map.texture.name=et.name+".shadowMap",z.camera.updateProjectionMatrix()}n.setRenderTarget(z.map),n.clear();const vt=z.getViewportCount();for(let Tt=0;Tt<vt;Tt++){const Dt=z.getViewport(Tt);o.set(r.x*Dt.x,r.y*Dt.y,r.x*Dt.z,r.y*Dt.w),J.viewport(o),z.updateMatrices(et,Tt),i=z.getFrustum(),y(P,O,z.camera,et,this.type)}z.isPointLightShadow!==!0&&this.type===Cn&&w(z,O),z.needsUpdate=!1}h=this.type,_.needsUpdate=!1,n.setRenderTarget(T,E,D)};function w(C,P){const O=t.update(S);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new wi(s.x,s.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(P,null,O,d,S,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(P,null,O,p,S,null)}function b(C,P,O,T){let E=null;const D=O.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(D!==void 0)E=D;else if(E=O.isPointLight===!0?l:a,n.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0){const J=E.uuid,Y=P.uuid;let $=c[J];$===void 0&&($={},c[J]=$);let ot=$[Y];ot===void 0&&(ot=E.clone(),$[Y]=ot,P.addEventListener("dispose",N)),E=ot}if(E.visible=P.visible,E.wireframe=P.wireframe,T===Cn?E.side=P.shadowSide!==null?P.shadowSide:P.side:E.side=P.shadowSide!==null?P.shadowSide:f[P.side],E.alphaMap=P.alphaMap,E.alphaTest=P.alphaTest,E.map=P.map,E.clipShadows=P.clipShadows,E.clippingPlanes=P.clippingPlanes,E.clipIntersection=P.clipIntersection,E.displacementMap=P.displacementMap,E.displacementScale=P.displacementScale,E.displacementBias=P.displacementBias,E.wireframeLinewidth=P.wireframeLinewidth,E.linewidth=P.linewidth,O.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const J=n.properties.get(E);J.light=O}return E}function y(C,P,O,T,E){if(C.visible===!1)return;if(C.layers.test(P.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&E===Cn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,C.matrixWorld);const Y=t.update(C),$=C.material;if(Array.isArray($)){const ot=Y.groups;for(let K=0,et=ot.length;K<et;K++){const z=ot[K],ft=$[z.materialIndex];if(ft&&ft.visible){const vt=b(C,ft,T,E);C.onBeforeShadow(n,C,P,O,Y,vt,z),n.renderBufferDirect(O,null,Y,vt,C,z),C.onAfterShadow(n,C,P,O,Y,vt,z)}}}else if($.visible){const ot=b(C,$,T,E);C.onBeforeShadow(n,C,P,O,Y,ot,null),n.renderBufferDirect(O,null,Y,ot,C,null),C.onAfterShadow(n,C,P,O,Y,ot,null)}}const J=C.children;for(let Y=0,$=J.length;Y<$;Y++)y(J[Y],P,O,T,E)}function N(C){C.target.removeEventListener("dispose",N);for(const O in c){const T=c[O],E=C.target.uuid;E in T&&(T[E].dispose(),delete T[E])}}}const bM={[aa]:la,[ca]:ha,[ua]:da,[us]:fa,[la]:aa,[ha]:ca,[da]:ua,[fa]:us};function wM(n,t){function e(){let L=!1;const mt=new he;let Q=null;const nt=new he(0,0,0,0);return{setMask:function(xt){Q!==xt&&!L&&(n.colorMask(xt,xt,xt,xt),Q=xt)},setLocked:function(xt){L=xt},setClear:function(xt,gt,Ht,ue,Ae){Ae===!0&&(xt*=ue,gt*=ue,Ht*=ue),mt.set(xt,gt,Ht,ue),nt.equals(mt)===!1&&(n.clearColor(xt,gt,Ht,ue),nt.copy(mt))},reset:function(){L=!1,Q=null,nt.set(-1,0,0,0)}}}function i(){let L=!1,mt=!1,Q=null,nt=null,xt=null;return{setReversed:function(gt){if(mt!==gt){const Ht=t.get("EXT_clip_control");mt?Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.ZERO_TO_ONE_EXT):Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.NEGATIVE_ONE_TO_ONE_EXT);const ue=xt;xt=null,this.setClear(ue)}mt=gt},getReversed:function(){return mt},setTest:function(gt){gt?ht(n.DEPTH_TEST):wt(n.DEPTH_TEST)},setMask:function(gt){Q!==gt&&!L&&(n.depthMask(gt),Q=gt)},setFunc:function(gt){if(mt&&(gt=bM[gt]),nt!==gt){switch(gt){case aa:n.depthFunc(n.NEVER);break;case la:n.depthFunc(n.ALWAYS);break;case ca:n.depthFunc(n.LESS);break;case us:n.depthFunc(n.LEQUAL);break;case ua:n.depthFunc(n.EQUAL);break;case fa:n.depthFunc(n.GEQUAL);break;case ha:n.depthFunc(n.GREATER);break;case da:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}nt=gt}},setLocked:function(gt){L=gt},setClear:function(gt){xt!==gt&&(mt&&(gt=1-gt),n.clearDepth(gt),xt=gt)},reset:function(){L=!1,Q=null,nt=null,xt=null,mt=!1}}}function s(){let L=!1,mt=null,Q=null,nt=null,xt=null,gt=null,Ht=null,ue=null,Ae=null;return{setTest:function(te){L||(te?ht(n.STENCIL_TEST):wt(n.STENCIL_TEST))},setMask:function(te){mt!==te&&!L&&(n.stencilMask(te),mt=te)},setFunc:function(te,en,En){(Q!==te||nt!==en||xt!==En)&&(n.stencilFunc(te,en,En),Q=te,nt=en,xt=En)},setOp:function(te,en,En){(gt!==te||Ht!==en||ue!==En)&&(n.stencilOp(te,en,En),gt=te,Ht=en,ue=En)},setLocked:function(te){L=te},setClear:function(te){Ae!==te&&(n.clearStencil(te),Ae=te)},reset:function(){L=!1,mt=null,Q=null,nt=null,xt=null,gt=null,Ht=null,ue=null,Ae=null}}}const r=new e,o=new i,a=new s,l=new WeakMap,c=new WeakMap;let u={},f={},d=new WeakMap,p=[],x=null,S=!1,_=null,h=null,w=null,b=null,y=null,N=null,C=null,P=new se(0,0,0),O=0,T=!1,E=null,D=null,J=null,Y=null,$=null;const ot=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,et=0;const z=n.getParameter(n.VERSION);z.indexOf("WebGL")!==-1?(et=parseFloat(/^WebGL (\d)/.exec(z)[1]),K=et>=1):z.indexOf("OpenGL ES")!==-1&&(et=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),K=et>=2);let ft=null,vt={};const Tt=n.getParameter(n.SCISSOR_BOX),Dt=n.getParameter(n.VIEWPORT),Kt=new he().fromArray(Tt),tt=new he().fromArray(Dt);function ut(L,mt,Q,nt){const xt=new Uint8Array(4),gt=n.createTexture();n.bindTexture(L,gt),n.texParameteri(L,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(L,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ht=0;Ht<Q;Ht++)L===n.TEXTURE_3D||L===n.TEXTURE_2D_ARRAY?n.texImage3D(mt,0,n.RGBA,1,1,nt,0,n.RGBA,n.UNSIGNED_BYTE,xt):n.texImage2D(mt+Ht,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xt);return gt}const Et={};Et[n.TEXTURE_2D]=ut(n.TEXTURE_2D,n.TEXTURE_2D,1),Et[n.TEXTURE_CUBE_MAP]=ut(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Et[n.TEXTURE_2D_ARRAY]=ut(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Et[n.TEXTURE_3D]=ut(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ht(n.DEPTH_TEST),o.setFunc(us),Z(!1),q(sc),ht(n.CULL_FACE),g(Jn);function ht(L){u[L]!==!0&&(n.enable(L),u[L]=!0)}function wt(L){u[L]!==!1&&(n.disable(L),u[L]=!1)}function It(L,mt){return f[L]!==mt?(n.bindFramebuffer(L,mt),f[L]=mt,L===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=mt),L===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=mt),!0):!1}function Ot(L,mt){let Q=p,nt=!1;if(L){Q=d.get(mt),Q===void 0&&(Q=[],d.set(mt,Q));const xt=L.textures;if(Q.length!==xt.length||Q[0]!==n.COLOR_ATTACHMENT0){for(let gt=0,Ht=xt.length;gt<Ht;gt++)Q[gt]=n.COLOR_ATTACHMENT0+gt;Q.length=xt.length,nt=!0}}else Q[0]!==n.BACK&&(Q[0]=n.BACK,nt=!0);nt&&n.drawBuffers(Q)}function re(L){return x!==L?(n.useProgram(L),x=L,!0):!1}const Xt={[vi]:n.FUNC_ADD,[gm]:n.FUNC_SUBTRACT,[vm]:n.FUNC_REVERSE_SUBTRACT};Xt[xm]=n.MIN,Xt[Mm]=n.MAX;const A={[Sm]:n.ZERO,[Em]:n.ONE,[ym]:n.SRC_COLOR,[ra]:n.SRC_ALPHA,[Cm]:n.SRC_ALPHA_SATURATE,[wm]:n.DST_COLOR,[Am]:n.DST_ALPHA,[Tm]:n.ONE_MINUS_SRC_COLOR,[oa]:n.ONE_MINUS_SRC_ALPHA,[Rm]:n.ONE_MINUS_DST_COLOR,[bm]:n.ONE_MINUS_DST_ALPHA,[Pm]:n.CONSTANT_COLOR,[Dm]:n.ONE_MINUS_CONSTANT_COLOR,[Lm]:n.CONSTANT_ALPHA,[Um]:n.ONE_MINUS_CONSTANT_ALPHA};function g(L,mt,Q,nt,xt,gt,Ht,ue,Ae,te){if(L===Jn){S===!0&&(wt(n.BLEND),S=!1);return}if(S===!1&&(ht(n.BLEND),S=!0),L!==_m){if(L!==_||te!==T){if((h!==vi||y!==vi)&&(n.blendEquation(n.FUNC_ADD),h=vi,y=vi),te)switch(L){case rs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case rc:n.blendFunc(n.ONE,n.ONE);break;case oc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ac:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case rs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case rc:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case oc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ac:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}w=null,b=null,N=null,C=null,P.set(0,0,0),O=0,_=L,T=te}return}xt=xt||mt,gt=gt||Q,Ht=Ht||nt,(mt!==h||xt!==y)&&(n.blendEquationSeparate(Xt[mt],Xt[xt]),h=mt,y=xt),(Q!==w||nt!==b||gt!==N||Ht!==C)&&(n.blendFuncSeparate(A[Q],A[nt],A[gt],A[Ht]),w=Q,b=nt,N=gt,C=Ht),(ue.equals(P)===!1||Ae!==O)&&(n.blendColor(ue.r,ue.g,ue.b,Ae),P.copy(ue),O=Ae),_=L,T=!1}function X(L,mt){L.side===Ln?wt(n.CULL_FACE):ht(n.CULL_FACE);let Q=L.side===ze;mt&&(Q=!Q),Z(Q),L.blending===rs&&L.transparent===!1?g(Jn):g(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),r.setMask(L.colorWrite);const nt=L.stencilWrite;a.setTest(nt),nt&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),st(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ht(n.SAMPLE_ALPHA_TO_COVERAGE):wt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Z(L){E!==L&&(L?n.frontFace(n.CW):n.frontFace(n.CCW),E=L)}function q(L){L!==dm?(ht(n.CULL_FACE),L!==D&&(L===sc?n.cullFace(n.BACK):L===pm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):wt(n.CULL_FACE),D=L}function V(L){L!==J&&(K&&n.lineWidth(L),J=L)}function st(L,mt,Q){L?(ht(n.POLYGON_OFFSET_FILL),(Y!==mt||$!==Q)&&(n.polygonOffset(mt,Q),Y=mt,$=Q)):wt(n.POLYGON_OFFSET_FILL)}function j(L){L?ht(n.SCISSOR_TEST):wt(n.SCISSOR_TEST)}function v(L){L===void 0&&(L=n.TEXTURE0+ot-1),ft!==L&&(n.activeTexture(L),ft=L)}function m(L,mt,Q){Q===void 0&&(ft===null?Q=n.TEXTURE0+ot-1:Q=ft);let nt=vt[Q];nt===void 0&&(nt={type:void 0,texture:void 0},vt[Q]=nt),(nt.type!==L||nt.texture!==mt)&&(ft!==Q&&(n.activeTexture(Q),ft=Q),n.bindTexture(L,mt||Et[L]),nt.type=L,nt.texture=mt)}function R(){const L=vt[ft];L!==void 0&&L.type!==void 0&&(n.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function I(){try{n.compressedTexImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function H(){try{n.compressedTexImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function B(){try{n.texSubImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function lt(){try{n.texSubImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function rt(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function at(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ut(){try{n.texStorage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function it(){try{n.texStorage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function dt(){try{n.texImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function yt(){try{n.texImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Rt(L){Kt.equals(L)===!1&&(n.scissor(L.x,L.y,L.z,L.w),Kt.copy(L))}function Mt(L){tt.equals(L)===!1&&(n.viewport(L.x,L.y,L.z,L.w),tt.copy(L))}function Lt(L,mt){let Q=c.get(mt);Q===void 0&&(Q=new WeakMap,c.set(mt,Q));let nt=Q.get(L);nt===void 0&&(nt=n.getUniformBlockIndex(mt,L.name),Q.set(L,nt))}function Ct(L,mt){const nt=c.get(mt).get(L);l.get(mt)!==nt&&(n.uniformBlockBinding(mt,nt,L.__bindingPointIndex),l.set(mt,nt))}function $t(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ft=null,vt={},f={},d=new WeakMap,p=[],x=null,S=!1,_=null,h=null,w=null,b=null,y=null,N=null,C=null,P=new se(0,0,0),O=0,T=!1,E=null,D=null,J=null,Y=null,$=null,Kt.set(0,0,n.canvas.width,n.canvas.height),tt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:ht,disable:wt,bindFramebuffer:It,drawBuffers:Ot,useProgram:re,setBlending:g,setMaterial:X,setFlipSided:Z,setCullFace:q,setLineWidth:V,setPolygonOffset:st,setScissorTest:j,activeTexture:v,bindTexture:m,unbindTexture:R,compressedTexImage2D:I,compressedTexImage3D:H,texImage2D:dt,texImage3D:yt,updateUBOMapping:Lt,uniformBlockBinding:Ct,texStorage2D:Ut,texStorage3D:it,texSubImage2D:B,texSubImage3D:lt,compressedTexSubImage2D:rt,compressedTexSubImage3D:at,scissor:Rt,viewport:Mt,reset:$t}}function RM(n,t,e,i,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new kt,u=new WeakMap;let f;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(v,m){return p?new OffscreenCanvas(v,m):Ws("canvas")}function S(v,m,R){let I=1;const H=j(v);if((H.width>R||H.height>R)&&(I=R/Math.max(H.width,H.height)),I<1)if(typeof HTMLImageElement<"u"&&v instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&v instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&v instanceof ImageBitmap||typeof VideoFrame<"u"&&v instanceof VideoFrame){const B=Math.floor(I*H.width),lt=Math.floor(I*H.height);f===void 0&&(f=x(B,lt));const rt=m?x(B,lt):f;return rt.width=B,rt.height=lt,rt.getContext("2d").drawImage(v,0,0,B,lt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+H.width+"x"+H.height+") to ("+B+"x"+lt+")."),rt}else return"data"in v&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+H.width+"x"+H.height+")."),v;return v}function _(v){return v.generateMipmaps}function h(v){n.generateMipmap(v)}function w(v){return v.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:v.isWebGL3DRenderTarget?n.TEXTURE_3D:v.isWebGLArrayRenderTarget||v.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(v,m,R,I,H=!1){if(v!==null){if(n[v]!==void 0)return n[v];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+v+"'")}let B=m;if(m===n.RED&&(R===n.FLOAT&&(B=n.R32F),R===n.HALF_FLOAT&&(B=n.R16F),R===n.UNSIGNED_BYTE&&(B=n.R8)),m===n.RED_INTEGER&&(R===n.UNSIGNED_BYTE&&(B=n.R8UI),R===n.UNSIGNED_SHORT&&(B=n.R16UI),R===n.UNSIGNED_INT&&(B=n.R32UI),R===n.BYTE&&(B=n.R8I),R===n.SHORT&&(B=n.R16I),R===n.INT&&(B=n.R32I)),m===n.RG&&(R===n.FLOAT&&(B=n.RG32F),R===n.HALF_FLOAT&&(B=n.RG16F),R===n.UNSIGNED_BYTE&&(B=n.RG8)),m===n.RG_INTEGER&&(R===n.UNSIGNED_BYTE&&(B=n.RG8UI),R===n.UNSIGNED_SHORT&&(B=n.RG16UI),R===n.UNSIGNED_INT&&(B=n.RG32UI),R===n.BYTE&&(B=n.RG8I),R===n.SHORT&&(B=n.RG16I),R===n.INT&&(B=n.RG32I)),m===n.RGB_INTEGER&&(R===n.UNSIGNED_BYTE&&(B=n.RGB8UI),R===n.UNSIGNED_SHORT&&(B=n.RGB16UI),R===n.UNSIGNED_INT&&(B=n.RGB32UI),R===n.BYTE&&(B=n.RGB8I),R===n.SHORT&&(B=n.RGB16I),R===n.INT&&(B=n.RGB32I)),m===n.RGBA_INTEGER&&(R===n.UNSIGNED_BYTE&&(B=n.RGBA8UI),R===n.UNSIGNED_SHORT&&(B=n.RGBA16UI),R===n.UNSIGNED_INT&&(B=n.RGBA32UI),R===n.BYTE&&(B=n.RGBA8I),R===n.SHORT&&(B=n.RGBA16I),R===n.INT&&(B=n.RGBA32I)),m===n.RGB&&R===n.UNSIGNED_INT_5_9_9_9_REV&&(B=n.RGB9_E5),m===n.RGBA){const lt=H?Gr:jt.getTransfer(I);R===n.FLOAT&&(B=n.RGBA32F),R===n.HALF_FLOAT&&(B=n.RGBA16F),R===n.UNSIGNED_BYTE&&(B=lt===ee?n.SRGB8_ALPHA8:n.RGBA8),R===n.UNSIGNED_SHORT_4_4_4_4&&(B=n.RGBA4),R===n.UNSIGNED_SHORT_5_5_5_1&&(B=n.RGB5_A1)}return(B===n.R16F||B===n.R32F||B===n.RG16F||B===n.RG32F||B===n.RGBA16F||B===n.RGBA32F)&&t.get("EXT_color_buffer_float"),B}function y(v,m){let R;return v?m===null||m===bi||m===ds?R=n.DEPTH24_STENCIL8:m===Un?R=n.DEPTH32F_STENCIL8:m===Gs&&(R=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===bi||m===ds?R=n.DEPTH_COMPONENT24:m===Un?R=n.DEPTH_COMPONENT32F:m===Gs&&(R=n.DEPTH_COMPONENT16),R}function N(v,m){return _(v)===!0||v.isFramebufferTexture&&v.minFilter!==fn&&v.minFilter!==vn?Math.log2(Math.max(m.width,m.height))+1:v.mipmaps!==void 0&&v.mipmaps.length>0?v.mipmaps.length:v.isCompressedTexture&&Array.isArray(v.image)?m.mipmaps.length:1}function C(v){const m=v.target;m.removeEventListener("dispose",C),O(m),m.isVideoTexture&&u.delete(m)}function P(v){const m=v.target;m.removeEventListener("dispose",P),E(m)}function O(v){const m=i.get(v);if(m.__webglInit===void 0)return;const R=v.source,I=d.get(R);if(I){const H=I[m.__cacheKey];H.usedTimes--,H.usedTimes===0&&T(v),Object.keys(I).length===0&&d.delete(R)}i.remove(v)}function T(v){const m=i.get(v);n.deleteTexture(m.__webglTexture);const R=v.source,I=d.get(R);delete I[m.__cacheKey],o.memory.textures--}function E(v){const m=i.get(v);if(v.depthTexture&&(v.depthTexture.dispose(),i.remove(v.depthTexture)),v.isWebGLCubeRenderTarget)for(let I=0;I<6;I++){if(Array.isArray(m.__webglFramebuffer[I]))for(let H=0;H<m.__webglFramebuffer[I].length;H++)n.deleteFramebuffer(m.__webglFramebuffer[I][H]);else n.deleteFramebuffer(m.__webglFramebuffer[I]);m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer[I])}else{if(Array.isArray(m.__webglFramebuffer))for(let I=0;I<m.__webglFramebuffer.length;I++)n.deleteFramebuffer(m.__webglFramebuffer[I]);else n.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&n.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&n.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let I=0;I<m.__webglColorRenderbuffer.length;I++)m.__webglColorRenderbuffer[I]&&n.deleteRenderbuffer(m.__webglColorRenderbuffer[I]);m.__webglDepthRenderbuffer&&n.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const R=v.textures;for(let I=0,H=R.length;I<H;I++){const B=i.get(R[I]);B.__webglTexture&&(n.deleteTexture(B.__webglTexture),o.memory.textures--),i.remove(R[I])}i.remove(v)}let D=0;function J(){D=0}function Y(){const v=D;return v>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+v+" texture units while this GPU supports only "+s.maxTextures),D+=1,v}function $(v){const m=[];return m.push(v.wrapS),m.push(v.wrapT),m.push(v.wrapR||0),m.push(v.magFilter),m.push(v.minFilter),m.push(v.anisotropy),m.push(v.internalFormat),m.push(v.format),m.push(v.type),m.push(v.generateMipmaps),m.push(v.premultiplyAlpha),m.push(v.flipY),m.push(v.unpackAlignment),m.push(v.colorSpace),m.join()}function ot(v,m){const R=i.get(v);if(v.isVideoTexture&&V(v),v.isRenderTargetTexture===!1&&v.version>0&&R.__version!==v.version){const I=v.image;if(I===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(I.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{tt(R,v,m);return}}e.bindTexture(n.TEXTURE_2D,R.__webglTexture,n.TEXTURE0+m)}function K(v,m){const R=i.get(v);if(v.version>0&&R.__version!==v.version){tt(R,v,m);return}e.bindTexture(n.TEXTURE_2D_ARRAY,R.__webglTexture,n.TEXTURE0+m)}function et(v,m){const R=i.get(v);if(v.version>0&&R.__version!==v.version){tt(R,v,m);return}e.bindTexture(n.TEXTURE_3D,R.__webglTexture,n.TEXTURE0+m)}function z(v,m){const R=i.get(v);if(v.version>0&&R.__version!==v.version){ut(R,v,m);return}e.bindTexture(n.TEXTURE_CUBE_MAP,R.__webglTexture,n.TEXTURE0+m)}const ft={[_a]:n.REPEAT,[Mi]:n.CLAMP_TO_EDGE,[ga]:n.MIRRORED_REPEAT},vt={[fn]:n.NEAREST,[km]:n.NEAREST_MIPMAP_NEAREST,[nr]:n.NEAREST_MIPMAP_LINEAR,[vn]:n.LINEAR,[xo]:n.LINEAR_MIPMAP_NEAREST,[Si]:n.LINEAR_MIPMAP_LINEAR},Tt={[jm]:n.NEVER,[t_]:n.ALWAYS,[Km]:n.LESS,[Tf]:n.LEQUAL,[Zm]:n.EQUAL,[$m]:n.GEQUAL,[Qm]:n.GREATER,[Jm]:n.NOTEQUAL};function Dt(v,m){if(m.type===Un&&t.has("OES_texture_float_linear")===!1&&(m.magFilter===vn||m.magFilter===xo||m.magFilter===nr||m.magFilter===Si||m.minFilter===vn||m.minFilter===xo||m.minFilter===nr||m.minFilter===Si)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(v,n.TEXTURE_WRAP_S,ft[m.wrapS]),n.texParameteri(v,n.TEXTURE_WRAP_T,ft[m.wrapT]),(v===n.TEXTURE_3D||v===n.TEXTURE_2D_ARRAY)&&n.texParameteri(v,n.TEXTURE_WRAP_R,ft[m.wrapR]),n.texParameteri(v,n.TEXTURE_MAG_FILTER,vt[m.magFilter]),n.texParameteri(v,n.TEXTURE_MIN_FILTER,vt[m.minFilter]),m.compareFunction&&(n.texParameteri(v,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(v,n.TEXTURE_COMPARE_FUNC,Tt[m.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===fn||m.minFilter!==nr&&m.minFilter!==Si||m.type===Un&&t.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){const R=t.get("EXT_texture_filter_anisotropic");n.texParameterf(v,R.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,s.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function Kt(v,m){let R=!1;v.__webglInit===void 0&&(v.__webglInit=!0,m.addEventListener("dispose",C));const I=m.source;let H=d.get(I);H===void 0&&(H={},d.set(I,H));const B=$(m);if(B!==v.__cacheKey){H[B]===void 0&&(H[B]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,R=!0),H[B].usedTimes++;const lt=H[v.__cacheKey];lt!==void 0&&(H[v.__cacheKey].usedTimes--,lt.usedTimes===0&&T(m)),v.__cacheKey=B,v.__webglTexture=H[B].texture}return R}function tt(v,m,R){let I=n.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(I=n.TEXTURE_2D_ARRAY),m.isData3DTexture&&(I=n.TEXTURE_3D);const H=Kt(v,m),B=m.source;e.bindTexture(I,v.__webglTexture,n.TEXTURE0+R);const lt=i.get(B);if(B.version!==lt.__version||H===!0){e.activeTexture(n.TEXTURE0+R);const rt=jt.getPrimaries(jt.workingColorSpace),at=m.colorSpace===Qn?null:jt.getPrimaries(m.colorSpace),Ut=m.colorSpace===Qn||rt===at?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ut);let it=S(m.image,!1,s.maxTextureSize);it=st(m,it);const dt=r.convert(m.format,m.colorSpace),yt=r.convert(m.type);let Rt=b(m.internalFormat,dt,yt,m.colorSpace,m.isVideoTexture);Dt(I,m);let Mt;const Lt=m.mipmaps,Ct=m.isVideoTexture!==!0,$t=lt.__version===void 0||H===!0,L=B.dataReady,mt=N(m,it);if(m.isDepthTexture)Rt=y(m.format===ps,m.type),$t&&(Ct?e.texStorage2D(n.TEXTURE_2D,1,Rt,it.width,it.height):e.texImage2D(n.TEXTURE_2D,0,Rt,it.width,it.height,0,dt,yt,null));else if(m.isDataTexture)if(Lt.length>0){Ct&&$t&&e.texStorage2D(n.TEXTURE_2D,mt,Rt,Lt[0].width,Lt[0].height);for(let Q=0,nt=Lt.length;Q<nt;Q++)Mt=Lt[Q],Ct?L&&e.texSubImage2D(n.TEXTURE_2D,Q,0,0,Mt.width,Mt.height,dt,yt,Mt.data):e.texImage2D(n.TEXTURE_2D,Q,Rt,Mt.width,Mt.height,0,dt,yt,Mt.data);m.generateMipmaps=!1}else Ct?($t&&e.texStorage2D(n.TEXTURE_2D,mt,Rt,it.width,it.height),L&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,it.width,it.height,dt,yt,it.data)):e.texImage2D(n.TEXTURE_2D,0,Rt,it.width,it.height,0,dt,yt,it.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){Ct&&$t&&e.texStorage3D(n.TEXTURE_2D_ARRAY,mt,Rt,Lt[0].width,Lt[0].height,it.depth);for(let Q=0,nt=Lt.length;Q<nt;Q++)if(Mt=Lt[Q],m.format!==ln)if(dt!==null)if(Ct){if(L)if(m.layerUpdates.size>0){const xt=Dc(Mt.width,Mt.height,m.format,m.type);for(const gt of m.layerUpdates){const Ht=Mt.data.subarray(gt*xt/Mt.data.BYTES_PER_ELEMENT,(gt+1)*xt/Mt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,gt,Mt.width,Mt.height,1,dt,Ht)}m.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,Mt.width,Mt.height,it.depth,dt,Mt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Q,Rt,Mt.width,Mt.height,it.depth,0,Mt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ct?L&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,Q,0,0,0,Mt.width,Mt.height,it.depth,dt,yt,Mt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,Q,Rt,Mt.width,Mt.height,it.depth,0,dt,yt,Mt.data)}else{Ct&&$t&&e.texStorage2D(n.TEXTURE_2D,mt,Rt,Lt[0].width,Lt[0].height);for(let Q=0,nt=Lt.length;Q<nt;Q++)Mt=Lt[Q],m.format!==ln?dt!==null?Ct?L&&e.compressedTexSubImage2D(n.TEXTURE_2D,Q,0,0,Mt.width,Mt.height,dt,Mt.data):e.compressedTexImage2D(n.TEXTURE_2D,Q,Rt,Mt.width,Mt.height,0,Mt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ct?L&&e.texSubImage2D(n.TEXTURE_2D,Q,0,0,Mt.width,Mt.height,dt,yt,Mt.data):e.texImage2D(n.TEXTURE_2D,Q,Rt,Mt.width,Mt.height,0,dt,yt,Mt.data)}else if(m.isDataArrayTexture)if(Ct){if($t&&e.texStorage3D(n.TEXTURE_2D_ARRAY,mt,Rt,it.width,it.height,it.depth),L)if(m.layerUpdates.size>0){const Q=Dc(it.width,it.height,m.format,m.type);for(const nt of m.layerUpdates){const xt=it.data.subarray(nt*Q/it.data.BYTES_PER_ELEMENT,(nt+1)*Q/it.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,nt,it.width,it.height,1,dt,yt,xt)}m.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,dt,yt,it.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Rt,it.width,it.height,it.depth,0,dt,yt,it.data);else if(m.isData3DTexture)Ct?($t&&e.texStorage3D(n.TEXTURE_3D,mt,Rt,it.width,it.height,it.depth),L&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,dt,yt,it.data)):e.texImage3D(n.TEXTURE_3D,0,Rt,it.width,it.height,it.depth,0,dt,yt,it.data);else if(m.isFramebufferTexture){if($t)if(Ct)e.texStorage2D(n.TEXTURE_2D,mt,Rt,it.width,it.height);else{let Q=it.width,nt=it.height;for(let xt=0;xt<mt;xt++)e.texImage2D(n.TEXTURE_2D,xt,Rt,Q,nt,0,dt,yt,null),Q>>=1,nt>>=1}}else if(Lt.length>0){if(Ct&&$t){const Q=j(Lt[0]);e.texStorage2D(n.TEXTURE_2D,mt,Rt,Q.width,Q.height)}for(let Q=0,nt=Lt.length;Q<nt;Q++)Mt=Lt[Q],Ct?L&&e.texSubImage2D(n.TEXTURE_2D,Q,0,0,dt,yt,Mt):e.texImage2D(n.TEXTURE_2D,Q,Rt,dt,yt,Mt);m.generateMipmaps=!1}else if(Ct){if($t){const Q=j(it);e.texStorage2D(n.TEXTURE_2D,mt,Rt,Q.width,Q.height)}L&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,dt,yt,it)}else e.texImage2D(n.TEXTURE_2D,0,Rt,dt,yt,it);_(m)&&h(I),lt.__version=B.version,m.onUpdate&&m.onUpdate(m)}v.__version=m.version}function ut(v,m,R){if(m.image.length!==6)return;const I=Kt(v,m),H=m.source;e.bindTexture(n.TEXTURE_CUBE_MAP,v.__webglTexture,n.TEXTURE0+R);const B=i.get(H);if(H.version!==B.__version||I===!0){e.activeTexture(n.TEXTURE0+R);const lt=jt.getPrimaries(jt.workingColorSpace),rt=m.colorSpace===Qn?null:jt.getPrimaries(m.colorSpace),at=m.colorSpace===Qn||lt===rt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,at);const Ut=m.isCompressedTexture||m.image[0].isCompressedTexture,it=m.image[0]&&m.image[0].isDataTexture,dt=[];for(let nt=0;nt<6;nt++)!Ut&&!it?dt[nt]=S(m.image[nt],!0,s.maxCubemapSize):dt[nt]=it?m.image[nt].image:m.image[nt],dt[nt]=st(m,dt[nt]);const yt=dt[0],Rt=r.convert(m.format,m.colorSpace),Mt=r.convert(m.type),Lt=b(m.internalFormat,Rt,Mt,m.colorSpace),Ct=m.isVideoTexture!==!0,$t=B.__version===void 0||I===!0,L=H.dataReady;let mt=N(m,yt);Dt(n.TEXTURE_CUBE_MAP,m);let Q;if(Ut){Ct&&$t&&e.texStorage2D(n.TEXTURE_CUBE_MAP,mt,Lt,yt.width,yt.height);for(let nt=0;nt<6;nt++){Q=dt[nt].mipmaps;for(let xt=0;xt<Q.length;xt++){const gt=Q[xt];m.format!==ln?Rt!==null?Ct?L&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt,0,0,gt.width,gt.height,Rt,gt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt,Lt,gt.width,gt.height,0,gt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ct?L&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt,0,0,gt.width,gt.height,Rt,Mt,gt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt,Lt,gt.width,gt.height,0,Rt,Mt,gt.data)}}}else{if(Q=m.mipmaps,Ct&&$t){Q.length>0&&mt++;const nt=j(dt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,mt,Lt,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(it){Ct?L&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,dt[nt].width,dt[nt].height,Rt,Mt,dt[nt].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Lt,dt[nt].width,dt[nt].height,0,Rt,Mt,dt[nt].data);for(let xt=0;xt<Q.length;xt++){const Ht=Q[xt].image[nt].image;Ct?L&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt+1,0,0,Ht.width,Ht.height,Rt,Mt,Ht.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt+1,Lt,Ht.width,Ht.height,0,Rt,Mt,Ht.data)}}else{Ct?L&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,Rt,Mt,dt[nt]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,Lt,Rt,Mt,dt[nt]);for(let xt=0;xt<Q.length;xt++){const gt=Q[xt];Ct?L&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt+1,0,0,Rt,Mt,gt.image[nt]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+nt,xt+1,Lt,Rt,Mt,gt.image[nt])}}}_(m)&&h(n.TEXTURE_CUBE_MAP),B.__version=H.version,m.onUpdate&&m.onUpdate(m)}v.__version=m.version}function Et(v,m,R,I,H,B){const lt=r.convert(R.format,R.colorSpace),rt=r.convert(R.type),at=b(R.internalFormat,lt,rt,R.colorSpace),Ut=i.get(m),it=i.get(R);if(it.__renderTarget=m,!Ut.__hasExternalTextures){const dt=Math.max(1,m.width>>B),yt=Math.max(1,m.height>>B);H===n.TEXTURE_3D||H===n.TEXTURE_2D_ARRAY?e.texImage3D(H,B,at,dt,yt,m.depth,0,lt,rt,null):e.texImage2D(H,B,at,dt,yt,0,lt,rt,null)}e.bindFramebuffer(n.FRAMEBUFFER,v),q(m)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,I,H,it.__webglTexture,0,Z(m)):(H===n.TEXTURE_2D||H>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&H<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,I,H,it.__webglTexture,B),e.bindFramebuffer(n.FRAMEBUFFER,null)}function ht(v,m,R){if(n.bindRenderbuffer(n.RENDERBUFFER,v),m.depthBuffer){const I=m.depthTexture,H=I&&I.isDepthTexture?I.type:null,B=y(m.stencilBuffer,H),lt=m.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,rt=Z(m);q(m)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,rt,B,m.width,m.height):R?n.renderbufferStorageMultisample(n.RENDERBUFFER,rt,B,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,B,m.width,m.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,lt,n.RENDERBUFFER,v)}else{const I=m.textures;for(let H=0;H<I.length;H++){const B=I[H],lt=r.convert(B.format,B.colorSpace),rt=r.convert(B.type),at=b(B.internalFormat,lt,rt,B.colorSpace),Ut=Z(m);R&&q(m)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ut,at,m.width,m.height):q(m)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ut,at,m.width,m.height):n.renderbufferStorage(n.RENDERBUFFER,at,m.width,m.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function wt(v,m){if(m&&m.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,v),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const I=i.get(m.depthTexture);I.__renderTarget=m,(!I.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),ot(m.depthTexture,0);const H=I.__webglTexture,B=Z(m);if(m.depthTexture.format===os)q(m)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,H,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,H,0);else if(m.depthTexture.format===ps)q(m)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,H,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,H,0);else throw new Error("Unknown depthTexture format")}function It(v){const m=i.get(v),R=v.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==v.depthTexture){const I=v.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),I){const H=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,I.removeEventListener("dispose",H)};I.addEventListener("dispose",H),m.__depthDisposeCallback=H}m.__boundDepthTexture=I}if(v.depthTexture&&!m.__autoAllocateDepthBuffer){if(R)throw new Error("target.depthTexture not supported in Cube render targets");wt(m.__webglFramebuffer,v)}else if(R){m.__webglDepthbuffer=[];for(let I=0;I<6;I++)if(e.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer[I]),m.__webglDepthbuffer[I]===void 0)m.__webglDepthbuffer[I]=n.createRenderbuffer(),ht(m.__webglDepthbuffer[I],v,!1);else{const H=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,B=m.__webglDepthbuffer[I];n.bindRenderbuffer(n.RENDERBUFFER,B),n.framebufferRenderbuffer(n.FRAMEBUFFER,H,n.RENDERBUFFER,B)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=n.createRenderbuffer(),ht(m.__webglDepthbuffer,v,!1);else{const I=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=m.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,I,n.RENDERBUFFER,H)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function Ot(v,m,R){const I=i.get(v);m!==void 0&&Et(I.__webglFramebuffer,v,v.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),R!==void 0&&It(v)}function re(v){const m=v.texture,R=i.get(v),I=i.get(m);v.addEventListener("dispose",P);const H=v.textures,B=v.isWebGLCubeRenderTarget===!0,lt=H.length>1;if(lt||(I.__webglTexture===void 0&&(I.__webglTexture=n.createTexture()),I.__version=m.version,o.memory.textures++),B){R.__webglFramebuffer=[];for(let rt=0;rt<6;rt++)if(m.mipmaps&&m.mipmaps.length>0){R.__webglFramebuffer[rt]=[];for(let at=0;at<m.mipmaps.length;at++)R.__webglFramebuffer[rt][at]=n.createFramebuffer()}else R.__webglFramebuffer[rt]=n.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){R.__webglFramebuffer=[];for(let rt=0;rt<m.mipmaps.length;rt++)R.__webglFramebuffer[rt]=n.createFramebuffer()}else R.__webglFramebuffer=n.createFramebuffer();if(lt)for(let rt=0,at=H.length;rt<at;rt++){const Ut=i.get(H[rt]);Ut.__webglTexture===void 0&&(Ut.__webglTexture=n.createTexture(),o.memory.textures++)}if(v.samples>0&&q(v)===!1){R.__webglMultisampledFramebuffer=n.createFramebuffer(),R.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,R.__webglMultisampledFramebuffer);for(let rt=0;rt<H.length;rt++){const at=H[rt];R.__webglColorRenderbuffer[rt]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,R.__webglColorRenderbuffer[rt]);const Ut=r.convert(at.format,at.colorSpace),it=r.convert(at.type),dt=b(at.internalFormat,Ut,it,at.colorSpace,v.isXRRenderTarget===!0),yt=Z(v);n.renderbufferStorageMultisample(n.RENDERBUFFER,yt,dt,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+rt,n.RENDERBUFFER,R.__webglColorRenderbuffer[rt])}n.bindRenderbuffer(n.RENDERBUFFER,null),v.depthBuffer&&(R.__webglDepthRenderbuffer=n.createRenderbuffer(),ht(R.__webglDepthRenderbuffer,v,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(B){e.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture),Dt(n.TEXTURE_CUBE_MAP,m);for(let rt=0;rt<6;rt++)if(m.mipmaps&&m.mipmaps.length>0)for(let at=0;at<m.mipmaps.length;at++)Et(R.__webglFramebuffer[rt][at],v,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,at);else Et(R.__webglFramebuffer[rt],v,m,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0);_(m)&&h(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(lt){for(let rt=0,at=H.length;rt<at;rt++){const Ut=H[rt],it=i.get(Ut);e.bindTexture(n.TEXTURE_2D,it.__webglTexture),Dt(n.TEXTURE_2D,Ut),Et(R.__webglFramebuffer,v,Ut,n.COLOR_ATTACHMENT0+rt,n.TEXTURE_2D,0),_(Ut)&&h(n.TEXTURE_2D)}e.unbindTexture()}else{let rt=n.TEXTURE_2D;if((v.isWebGL3DRenderTarget||v.isWebGLArrayRenderTarget)&&(rt=v.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(rt,I.__webglTexture),Dt(rt,m),m.mipmaps&&m.mipmaps.length>0)for(let at=0;at<m.mipmaps.length;at++)Et(R.__webglFramebuffer[at],v,m,n.COLOR_ATTACHMENT0,rt,at);else Et(R.__webglFramebuffer,v,m,n.COLOR_ATTACHMENT0,rt,0);_(m)&&h(rt),e.unbindTexture()}v.depthBuffer&&It(v)}function Xt(v){const m=v.textures;for(let R=0,I=m.length;R<I;R++){const H=m[R];if(_(H)){const B=w(v),lt=i.get(H).__webglTexture;e.bindTexture(B,lt),h(B),e.unbindTexture()}}}const A=[],g=[];function X(v){if(v.samples>0){if(q(v)===!1){const m=v.textures,R=v.width,I=v.height;let H=n.COLOR_BUFFER_BIT;const B=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,lt=i.get(v),rt=m.length>1;if(rt)for(let at=0;at<m.length;at++)e.bindFramebuffer(n.FRAMEBUFFER,lt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,lt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,lt.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,lt.__webglFramebuffer);for(let at=0;at<m.length;at++){if(v.resolveDepthBuffer&&(v.depthBuffer&&(H|=n.DEPTH_BUFFER_BIT),v.stencilBuffer&&v.resolveStencilBuffer&&(H|=n.STENCIL_BUFFER_BIT)),rt){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,lt.__webglColorRenderbuffer[at]);const Ut=i.get(m[at]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ut,0)}n.blitFramebuffer(0,0,R,I,0,0,R,I,H,n.NEAREST),l===!0&&(A.length=0,g.length=0,A.push(n.COLOR_ATTACHMENT0+at),v.depthBuffer&&v.resolveDepthBuffer===!1&&(A.push(B),g.push(B),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,A))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),rt)for(let at=0;at<m.length;at++){e.bindFramebuffer(n.FRAMEBUFFER,lt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,lt.__webglColorRenderbuffer[at]);const Ut=i.get(m[at]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,lt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.TEXTURE_2D,Ut,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,lt.__webglMultisampledFramebuffer)}else if(v.depthBuffer&&v.resolveDepthBuffer===!1&&l){const m=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[m])}}}function Z(v){return Math.min(s.maxSamples,v.samples)}function q(v){const m=i.get(v);return v.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function V(v){const m=o.render.frame;u.get(v)!==m&&(u.set(v,m),v.update())}function st(v,m){const R=v.colorSpace,I=v.format,H=v.type;return v.isCompressedTexture===!0||v.isVideoTexture===!0||R!==ms&&R!==Qn&&(jt.getTransfer(R)===ee?(I!==ln||H!==On)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",R)),m}function j(v){return typeof HTMLImageElement<"u"&&v instanceof HTMLImageElement?(c.width=v.naturalWidth||v.width,c.height=v.naturalHeight||v.height):typeof VideoFrame<"u"&&v instanceof VideoFrame?(c.width=v.displayWidth,c.height=v.displayHeight):(c.width=v.width,c.height=v.height),c}this.allocateTextureUnit=Y,this.resetTextureUnits=J,this.setTexture2D=ot,this.setTexture2DArray=K,this.setTexture3D=et,this.setTextureCube=z,this.rebindTextures=Ot,this.setupRenderTarget=re,this.updateRenderTargetMipmap=Xt,this.updateMultisampleRenderTarget=X,this.setupDepthRenderbuffer=It,this.setupFrameBufferTexture=Et,this.useMultisampledRTT=q}function CM(n,t){function e(i,s=Qn){let r;const o=jt.getTransfer(s);if(i===On)return n.UNSIGNED_BYTE;if(i===hl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===dl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===_f)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===pf)return n.BYTE;if(i===mf)return n.SHORT;if(i===Gs)return n.UNSIGNED_SHORT;if(i===fl)return n.INT;if(i===bi)return n.UNSIGNED_INT;if(i===Un)return n.FLOAT;if(i===qs)return n.HALF_FLOAT;if(i===gf)return n.ALPHA;if(i===vf)return n.RGB;if(i===ln)return n.RGBA;if(i===xf)return n.LUMINANCE;if(i===Mf)return n.LUMINANCE_ALPHA;if(i===os)return n.DEPTH_COMPONENT;if(i===ps)return n.DEPTH_STENCIL;if(i===Sf)return n.RED;if(i===pl)return n.RED_INTEGER;if(i===Ef)return n.RG;if(i===ml)return n.RG_INTEGER;if(i===_l)return n.RGBA_INTEGER;if(i===Cr||i===Pr||i===Dr||i===Lr)if(o===ee)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Cr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Pr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Dr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Lr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Cr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Pr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Dr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Lr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===va||i===xa||i===Ma||i===Sa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===va)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===xa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ma)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Sa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ea||i===ya||i===Ta)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Ea||i===ya)return o===ee?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Ta)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Aa||i===ba||i===wa||i===Ra||i===Ca||i===Pa||i===Da||i===La||i===Ua||i===Ia||i===Na||i===Fa||i===Oa||i===Ba)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Aa)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ba)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===wa)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Ra)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ca)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Pa)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Da)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===La)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ua)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ia)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Na)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Fa)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Oa)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Ba)return o===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ur||i===Ha||i===za)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===Ur)return o===ee?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ha)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===za)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===yf||i===Va||i===Ga||i===ka)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===Ur)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Va)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ga)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ka)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ds?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const PM={type:"move"};class Yo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Mr,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Mr,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new G,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new G),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Mr,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new G,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new G),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const S of t.hand.values()){const _=e.getJointPose(S,i),h=this._getHandJoint(c,S);_!==null&&(h.matrix.fromArray(_.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=_.radius),h.visible=_!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),p=.02,x=.005;c.inputState.pinching&&d>p+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=p-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,i),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,i),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(PM)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new Mr;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const DM=`
void main() {
