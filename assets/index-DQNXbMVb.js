...
#define LOW_PRECISION`),t}function RM(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===pf?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===zm?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Pn&&(t="SHADOWMAP_TYPE_VSM"),t}function CM(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case us:case fs:t="ENVMAP_TYPE_CUBE";break;case Qr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function PM(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case fs:t="ENVMAP_MODE_REFRACTION";break}return t}function DM(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case mf:t="ENVMAP_BLENDING_MULTIPLY";break;case s_:t="ENVMAP_BLENDING_MIX";break;case r_:t="ENVMAP_BLENDING_ADD";break}return t}function LM(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function UM(n,t,e,i){const s=n.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=RM(e),c=CM(e),u=PM(e),f=DM(e),d=LM(e),p=MM(e),x=SM(r),S=s.createProgram();let _,h,w=e.glslVersion?"#version "+e.glslVersion+`
